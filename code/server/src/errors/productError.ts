...
/**
 * Represents an error that occurs when a product model already exists.
 */
...
export { ProductNotFoundError, ModelAlreadyExistsError, ProductSoldError, EmptyProductStockError, LowProductStockError }