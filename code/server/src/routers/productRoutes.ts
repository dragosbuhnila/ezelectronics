...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            ...
            body("category").isString().notEmpty().isIn([Category.APPLIANCE, Category.LAPTOP, Category.SMARTPHONE]),
            body("quantity").isInt({ min: 1 }),
            body("details").isString(),
            body("sellingPrice").isFloat({ min: 1 }),
            body("arrivalDate").isISO8601().optional(),
        ...
        this.router.patch(
            ...
            body("quantity").isInt({ min: 1 }),
            body("changeDate").isISO8601().optional(),
            this.errorHandler.validateRequest,
        ...
        this.router.patch(
            ...
            param("model").isString().notEmpty(),
            body("quantity").isInt({ min: 1 }),
            body("sellingDate").isISO8601().optional(),
            this.errorHandler.validateRequest,
        ...
        this.router.get(
            ...
            query("grouping").isString().isIn(["category", "model"]).custom((value, { req }) => {
                ...
                else if (value === "model" && (!req.query.model || req.query.category)) {
                    return false
                }
                return true
            }).optional(),
            query("category").isString().isIn([Category.APPLIANCE, Category.LAPTOP, Category.SMARTPHONE]).optional(),
